...
import { useGetNotificationHistoryMutation, useGetNotificationHistoryQuery } from "../../../../api/notification";
...
const SendNotificationAllUserDataGrid = ({ IdSubColor, setOpenCustomerDetail }) => {
  // useGetNotificationHistoryQuery()
    ...
    // const {data:notificationHistoryData,isLoading,refetch,isSuccess} = useGetNotificationHistoryQuery(`page=${page}&size=${size}&sortBy=createdAt`)
  ...
  const getNotificationHistoryFunc = () => {
    getNotificationHistory({page:page,size:size}).then((res) => {
      if(res.data){
  ...
  //   setNotificationHistory(notificationHistoryData?.allNotificationHistoryList)
  //   setTotalRecordsCount(notificationHistoryData?.totalNotificatonsCount)
    
  // }, [notificationHistoryData])

  // console.log("notificationHistoryData data notification history ",notificationHistoryData)
  console.log("notificationHistoryData data notification history ",notificationHistory)
  return (
    <>
      <Box width="100%">
        <Box sx={{my:"10px"}}>
            ...
            <>
              <Box sx={{ width: "100%" }}>
                <StyledDataGrid
                  ...
                  rows={notificationHistory?.allNotificationHistoryList || []}
...
export default SendNotificationAllUserDataGrid;
