...
import {useGetCatererRequestWithStatusRejectedMutation,useGetCatererRequestWithStatusRequestMutation,useGetCatererRequestWithStatusTerminatedMutation, useGetCatererRequestWithStatusRevisionMutation } from "../../../api/caterers";
...
export const CustomerHeader2 = ({
  ...
  TypoMarginBottom,
  TypoMarginTop,
  SetNewCatererRequestData,
  refetchNewCatererRequestData
}) => {

  const [gtCatererRequestWithStatusRevision, revisionresdata] = useGetCatererRequestWithStatusRevisionMutation()
  const [getCatererRequestWithStatusRejected, rejectedresdata] =
  useGetCatererRequestWithStatusRejectedMutation()
  const [getCatererRequestWithStatusRequest, requestresdata] =
  useGetCatererRequestWithStatusRequestMutation()
  const [getCatererRequestWithStatusTerminated, terminatedresdata] =
  ...
  const handleClose = (indicator) => {
    if(indicator === "withStatusRevision"){
      gtCatererRequestWithStatusRevision({ page:1, size:10 }).then((res) => {
        if (res.data){
      ...
      getCatererRequestWithStatusRejected({ page:1, size:10 }).then((res) => {
        if (res.data){
            console.log("res.data newCatererRequestData ", res?.data?.data);
            SetNewCatererRequestData(res?.data?.data)
        }
      ...
      getCatererRequestWithStatusRequest({ page:1, size:10 }).then((res) => {
        if (res.data){
            console.log("res.data newCatererRequestData ", res?.data?.data);
            SetNewCatererRequestData(res?.data?.data)
        }
      ...
      getCatererRequestWithStatusTerminated({ page:1, size:10 }).then((res) => {
        if (res.data){
            console.log("res.data newCatererRequestData ", res?.data?.data);
            SetNewCatererRequestData(res?.data?.data)
        }
                ...
                <Box>
                  ...
                  >
                    ...
                    >
                      ...
                      <MenuItem sx={{color: "#2B817B",}} onClick={() => {handleClose("withStatusRevision")}}>revision</MenuItem>
                      ...
                      <MenuItem sx={{color: "#2B817B",}} onClick={() => {refetchNewCatererRequestData();  setAnchorEl(null);}}>All</MenuItem>
                    </Menu>
                </Box>
