...
import { useAddSubCusineMutation } from "../../../../api/subCuisine";
...
const AddSubCuisine = ({handleAddModalClose,refetchAllSubCuisinesData}) => {
    
  const [addSubCuisine, { isLoading }] = useAddSubCusineMutation()
  const [image, setImage] = useState("assets/images/image profile.svg");
    ...
    onSubmit: (values, action) => {
      console.log("AddSubCuisine Form => ", values);
      ...
      addSubCuisine(formData).then((res) => {
        if (res.data) {
  ...
  return (
    <>
      <Grid container justifyContent="center" alignItems="center">
        <Grid item xs={12}>
            <Typography sx={{color:"#9EA3AE",fontSize:"16px",fontWeight:"400",mt:"6px"}}>Add Sub Cuisine</Typography>
            <Box component="form" onSubmit={formik.handleSubmit}  autoComplete="off">
              ...
              <Box sx={{mt:"40px",mb:"20px"}}>
                ...
                }}} variant="contained" disabled={isLoading} fullWidth >Add Sub Cuisine</Button>
              </Box>
            </Box>
        </Grid>
      </Grid>
