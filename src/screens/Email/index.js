...
import { useGetUpdateEmailstatusMutation } from 'api/email';
...
const Email = () => {
    ...
    // const [updateEmailstatus, resdata] = useGetUpdateEmailstatusMutation()

    const [isEmailFormShown, setIsEmailFormShown] = React.useState(false);
    ...
    const handleCloseIsEmailFormShown = () => {
            ...
            <Box width="100%">
                ...
                <Grid container gap={2} justifyContent="space-between">
                    ...
                    <Grid item xs={12} md={2.2} sx={{minHeight:"80vh"}}>
                        <Box sx={{height:"auto"}}>
                            ...
                            sx={{minHeight:"100%",maxWidth:"100%",width:"100%"}}>
                                <StyledTab label="Inbox" {...a11yProps(0)} icon={<img src="assets/emailPageImages/inboxIcon.svg" alt="moreIcon" />} iconPosition="start"  onClick={handleCloseIsEmailFormShown}/>
                                <StyledTab label="Starred" {...a11yProps(1)} icon={<img src="assets/emailPageImages/starred.svg" alt="moreIcon" />} iconPosition="start" onClick={handleCloseIsEmailFormShown}/>
                                <StyledTab label="Sent" {...a11yProps(2)} icon={<img src="assets/emailPageImages/sentIcon.svg" alt="moreIcon" />} iconPosition="start" onClick={handleCloseIsEmailFormShown}/>
                                <StyledTab label="Important" {...a11yProps(3)} icon={<img src="assets/emailPageImages/importantMessageIcon.svg" alt="moreIcon" />} iconPosition="start" onClick={handleCloseIsEmailFormShown}/>
                                <StyledTab label="Trash" {...a11yProps(4)} icon={<img src="assets/emailPageImages/trashIcon.svg" alt="moreIcon" />} iconPosition="start" onClick={handleCloseIsEmailFormShown}/>
                                {/* <StyledTab label="Inbox" {...a11yProps(0)} icon={<img src="assets/emailPageImages/inboxIcon.svg" alt="moreIcon" />} iconPosition="start"  onClick={()=> {setOpen2(false); setIsEmailFormShown(false);}}/>
                                <StyledTab label="Starred" {...a11yProps(1)} icon={<img src="assets/emailPageImages/starred.svg" alt="moreIcon" />} iconPosition="start" onClick={()=> {setOpen2(false); setIsEmailFormShown(false);}}/>
                                <StyledTab label="Sent" {...a11yProps(2)} icon={<img src="assets/emailPageImages/sentIcon.svg" alt="moreIcon" />} iconPosition="start" onClick={()=> {setOpen2(false); setIsEmailFormShown(false);}}/>
                                <StyledTab label="Important" {...a11yProps(3)} icon={<img src="assets/emailPageImages/importantMessageIcon.svg" alt="moreIcon" />} iconPosition="start" onClick={()=> {setOpen2(false); setIsEmailFormShown(false);}}/>
                                <StyledTab label="Trash" {...a11yProps(4)} icon={<img src="assets/emailPageImages/trashIcon.svg" alt="moreIcon" />} iconPosition="start" onClick={()=> {setOpen2(false); setIsEmailFormShown(false);}}/> */}
                            </StyledTabs>
                    ...
                    <Grid item xs={12} md={9.5} sx={{minHeight:"60vh"}}>
                        {
                            isEmailFormShown? <>
                            {/* <EmailForm handleOpenModal={()=>{setOpen2(true)}} /> */}
                            <EmailForm />
                            </> 
                            : 
                            <>
                ...
                >
                    <Box sx={{my:"20px",minWidth:{xs:"310px",sm:"400px",md:"500px"},mb:"20px"}}>
                        <Box sx={{display:"flex",flexWrap:"wrap",justifyContent:"center",p:"16px 16px 32px 16px"}}>
                            <Box sx={{border:"1px solid #E1E1E6",borderRadius:"8px",p:"16px 16px 32px 16px",textAlign:"center",width:{xs:"45%"} }}>
                                {/* <IconButton sx={{backgroundColor:"#E8F7F6"}} onClick={()=> {setOpen(false); setIsEmailFormShown(true);}}> */}
                                <IconButton sx={{backgroundColor:"#E8F7F6"}} onClick={()=> {setOpen(false); setIsEmailFormShown(true);}}>
                                    <PersonIcon sx={{ color: "#2B817B",fontSize:{xs:"32px",md:"48px"} }} />
                                </IconButton>
                                <Typography sx={{fontSize: { xs: "13px", md: "16px" },fontWeight: "500",color: "#1A1824",}}>Specific People</Typography>  
                            </Box>
                            {/* <Box sx={{border:"1px solid #E1E1E6",borderRadius:"8px",p:"16px 16px 32px 16px",textAlign:"center",width:{xs:"45%"} }}> */}
                                {/* <IconButton sx={{backgroundColor:"#E8F7F6"}} onClick={()=> {setOpen(false); setIsEmailFormShown(true);}}> */}
                                {/* <IconButton sx={{backgroundColor:"#E8F7F6"}} onClick={()=> {setOpen(false); setIsEmailFormShown(true);}}>
