...
const SingleOrderDetails = ({selectedSingleOrder,setIsShownSingleOrderDetails}) => {
    ...
    <>
      <Box width="100%" p="20px">
        <CustomBreadcrumbs
          ...
          clickHandler={()=> { setIsShownSingleOrderDetails(false) }}
        />
        <OrderDetailsMainBox selectedsubscription ={selectedSingleOrder} hasPauseButton={false} hasEventBox={false}/>
        {/* <OrderDetailsMainBox SubscriptionMainCardData ={SubscriptionMainCardData} hasPauseButton={false} hasEventBox={false}/> */}
      </Box>
    </>
  );
};
