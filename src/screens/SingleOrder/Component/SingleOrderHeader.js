...
export const SingleOrderHeader = ({
  title,
  hasLastAddedBtn,
  hasAnyStatus,
  hasLastAddedBtnTitle,
  hasHistoryButton,
  hasExportButton,
  hasFilterBtn,
  hasTextButtonTitle1,
          ...
          <Box sx={{ display: "flex", mt: "10px" }}>
            {hasHistoryButton && (
              <Box sx={{ paddingRight: "16px" }}>
                ...
                onClick={historyBtnOnClickHandler && historyBtnOnClickHandler}
                >
                  <img src="./assets/images/timer.svg" alt="" />
                  <Typography ml="8px" sx={BtnTypo1}>
                    History
                  </Typography>
                </Button>
              </Box>
