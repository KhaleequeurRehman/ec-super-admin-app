...
export const CatererRequestNotification = ({item}) => {
  ...
  return (
    <div>
        <MainBox sx={{display: "flex", flexWrap: "wrap", justifyContent: "space-between"}}>
           ...
           <Box sx={{display: "flex",my:"10px"}}>
            <Button sx={{p:"8px 24px 8px 24px",borderStyle:"dashed",borderColor:"#80B3B0",color:"#2B817B",'&:hover':{borderStyle:"dashed",borderColor:"#80B3B0"}}} variant='outlined' onClick={item?.btnOnClickHandler && item?.btnOnClickHandler}>
            {item?.buttonText}
          </Button>
