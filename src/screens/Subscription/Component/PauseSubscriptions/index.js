...
// import { useUpdateCusineMutation } from "../../../../api/cusine";
...
const PauseSubscriptions = ({handleModalClose,refetchAllSubscriptionsData,selectedsubscription}) => {
  const [pauseSubscription, { isLoading }] = usePauseSubscriptionMutation()

  const [isOpenPauseConfirmDialog, setIsOpenPauseConfirmDialog] = useState(false);

  const [reason, setReason] = React.useState("");
  const [fromDateValue, setFromDateValue] = React.useState(dayjs('2014-08-18T21:11:54'));

  const [toDateValue, setToDateValue] = React.useState(dayjs('2014-08-18T21:11:54'));
  ...
  const handleClosePauseConfirmDialog = () => {
    setIsOpenPauseConfirmDialog(false);
  };

  const handleOpenPauseConfirmDialog = () => {
    setIsOpenPauseConfirmDialog(true);
  };
  ...
  const onSubmitHandler = () => {
    ...
    console.log("pause subscription formStateData ",formStateData);
    pauseSubscription(formStateData).then((res) => {
        if (res.data) {
  ...
  //     console.log("pauseSubscription Form => ", values);
  //     // handleModalClose()
  ...
  return (
    <>
            ...
            <Box>
              ...
              <Box sx={{display: "flex",justifyContent: "center",mt:"40px",mb:"20px" }}>
                ...
                <Box ml="24px">
                  ...
                  onClick={handleOpenPauseConfirmDialog}
                  >
                    {/* Pause */}
                    {/* Submit */}
                    Pause Subscription
      ...
      open={isOpenPauseConfirmDialog}
      handleClose={handleClosePauseConfirmDialog}
...
export default PauseSubscriptions;
